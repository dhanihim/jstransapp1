...
class AssignmentsTest < ApplicationSystemTestCase
  ...
  test "creating a Assignment" do
    ...
    fill_in "Active", with: @assignment.active
    fill_in "Document status", with: @assignment.document_status
    fill_in "Pickuptime", with: @assignment.pickuptime
    fill_in "Uid", with: @assignment.uid
